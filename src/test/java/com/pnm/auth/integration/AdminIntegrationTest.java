...
class AdminIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldAllowAdminActions() throws Exception {
        ...
        // 3. LOGIN AS ADMIN (With Trust Bypass)
    ...
    void shouldDenyNonAdmin() throws Exception {
        // ... (Same as previous, just trust seeding is needed if login logic enforces it)
        // Ensure you copy the Trust Seeding logic here too if your Login Orchestrator requires it.
        // For brevity, assuming you add it:
